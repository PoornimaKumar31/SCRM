...
@TestCaseID_ @UISID_8688
Scenario: CSM CFG Update Status Last connected Search
	Given user is on CSM CONFIGURATION UPDATE STATUS page
	When user type "Last connected" in search textbox
	And press enter
	Then device with the matching "Last connected" is displayed