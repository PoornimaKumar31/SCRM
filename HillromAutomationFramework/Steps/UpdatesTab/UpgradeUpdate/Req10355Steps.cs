...
{
    [Binding,Scope(Tag = "SoftwareRequirementID_10355")]
    public sealed class Req10355Steps
    {
        ...
        public Req10355Steps(ScenarioContext scenarioContext, IWebDriver driver)
        {
        ...
        public void GivenUserIsOnProgressaUpdatesPage()
        {
        ...
        {
            _updatesSelectUpdatePage.AssetTypeDropDown.SelectDDL(UpdatesSelectUpdatePageExpectedValues.ProgressaDeviceName);
        }
        ...
        public void ThenUpgradeDisplaysAsUpdateType()
        {
            ...
            (selectedUpdateType).Should().BeEquivalentTo(UpdatesSelectUpdatePageExpectedValues.UpdateTypeUpgrade, because: "Upgrade type should be displayed when user selects Update as option in Upgrade type dropdown in Progressa select updates page");
        }

        [Then(@"Progressa upgrade list is displayed")]
        public void ThenProgressaUpgradeListIsDisplayed()
        {
            (_updatesSelectUpdatePage.FileTableList.GetElementVisibility()).Should().BeTrue(because: "Progressa upgrade list should be displayed in Progressa select updates page");
        }

        [Then(@"Name column heading is displayed")]
        public void ThenNameColumnHeadingIsDisplayed()
        {
            (_updatesSelectUpdatePage.CentrellaAndRV700NameColumnHeading.GetElementVisibility()).Should().BeTrue(because: "Name column heading should be displayed in Progressa select updates page table");
            string ActualNameColumnHeadingText = _updatesSelectUpdatePage.CentrellaAndRV700NameColumnHeading.Text;
            (ActualNameColumnHeadingText).Should().BeEquivalentTo(UpdatesSelectUpdatePageExpectedValues.TableNameHeadingText, because: "Name heading name text should match with the expected value in Progressa select updates page table");
        }

        [Then(@"Date created column heading is displayed")]
        public void ThenDateCreatedColumnHeadingIsDisplayed()
        {
            (_updatesSelectUpdatePage.CentrellaAndRV700DateColumnHeading.GetElementVisibility()).Should().BeTrue(because: "Date column heading should be displayed in Progressa select updates page table");
            string ActualDateColumnHeadingText = _updatesSelectUpdatePage.CentrellaAndRV700DateColumnHeading.Text;
            (ActualDateColumnHeadingText).Should().BeEquivalentTo(UpdatesSelectUpdatePageExpectedValues.TableDateHeadingText, because: "Date heading name text should match with the expected value in Progressa select updates page table");
        }
        ...
        public void ThenNextButtonIsDisabled()
        {
            ...
            if(_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa upgrade elements"))
            {
                (_updatesSelectUpdatePage.NextButton.Enabled).Should().BeFalse(because: "Next button should be disabled since user didn't select any upgrade file in Progressa select Update page");
            }
            //for select assets page
            else if(_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa select assets elements"))
            {
                (_updateSelectDevicesPage.NextButton.Enabled).Should().BeFalse(because: "Next button should be disabled since user didn't select any device in Progressa select assets page");
            }
        ...
        public void ThenPageXOfYLabelIsDisplayed()
        {
            ...
            if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa upgrade elements"))
            {
                ...
                (_updatesSelectUpdatePage.PaginationXofY.GetElementVisibility()).Should().BeTrue(because: "Page x of y label should be displayed in Progressa Select Update page");
            }
            //for select assets page
            else if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa select assets elements"))
            {
                SetMethods.MoveTotheElement(_updateSelectDevicesPage.PaginationXofY, _driver, "Page x of y label");
                (_updateSelectDevicesPage.PaginationXofY.GetElementVisibility()).Should().BeTrue(because: "Page x of y label should be displayed in Progressa Select assets page");
            }
            //If this does not belong to any scenario
            else
            {
        ...
        public void ThenDisplayingXToYOfZResultsLabelIsDisplayed()
        {
            ...
            if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa upgrade elements"))
            {
                ...
                (_updatesSelectUpdatePage.PaginationDisplayXY.GetElementVisibility()).Should().BeTrue(because: "Displaying X - Y of z results label should be displayed in Progressa Select Update page");
            }
            //for select assets page
            else if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa select assets elements"))
            {
                SetMethods.MoveTotheElement(_updateSelectDevicesPage.PaginationDisplayXY, _driver, "Displaying x to y of z results label");
                (_updateSelectDevicesPage.PaginationDisplayXY.GetElementVisibility()).Should().BeTrue(because: "Displaying X - Y of z results label should be displayed in Progressa Select assets page");
            }
            //If this does not belong to any scenario
            else
            {
        ...
        public void ThenProgressaSelectAssetsPageIsDisplayed()
        {
            ...
            (IsSelectAssetPageDisplayed).Should().BeTrue(because: "Select assets page should be displayed since user clicked Enabled next button in Progressa Select assets page");
        }

        [Given(@"user is on Progressa Upgrade Select assets page")]
        public void GivenUserIsOnProgressaUpgradeSelectAssetsPage()
        {
            //go to updates tab
            GivenUserIsOnProgressaUpdatesPage();
        ...
        public void ThenLabelIsDisplayed(string labelName)
        {
            ...
            (label.GetElementVisibility()).Should().BeTrue(because: labelName + " label name should be displayed in Progressa Select Assets page");
            string LabelText = label.Text;
            (LabelText).Should().BeEquivalentTo(ExpectedLabelName, because: labelName + " label name should match with the expected value in Progressa Select Assets page");
        }

        [Then(@"location hierarchy selectors are displayed")]
        public void ThenLocationHierarchySelectorsAreDisplayed()
        {
            (_updateSelectDevicesPage.LocationHierarchy.GetElementVisibility()).Should().BeTrue(because: "location hierarchy selectors should be displayed in Progressa Select assets page.");
        }

        [Then(@"count of selected devices is displayed")]
        public void ThenCountOfSelectedDevicesIsDisplayed()
        {
            (_updateSelectDevicesPage.DeviceCount.GetElementVisibility()).Should().BeTrue(because: "count of selected devices should be displayed in Progressa Select assets page");
        }
        ...
        {
            //for select assets page
            if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa select assets elements"))
            {
                (_updateSelectDevicesPage.PreviousButton.Enabled).Should().BeTrue(because: "Previous button should be enabled in Progressa Select assets page");
            }
            //for review action page
            else if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa review action elements"))
            {
                (_updateReviewActionPage.PreviousButton.Enabled).Should().BeTrue(because: "Previous button should be enabled in Progressa Review Action page");
            }
            //If this does not belong to any scenario
            else
            {
        ...
        {
            (_updateSelectDevicesPage.SelectAllcheckBox.Selected).Should().BeFalse(because: "Select all checkbox should be unchecked by default in Progressa Select assets page");
        }
        ...
        public void ThenColumnHeadingIsDisplayed(string columnHeadingName)
        {
            ...
            (HeadingElement.GetElementVisibility()).Should().BeTrue(columnHeadingName + " column heading should be displayed in Progressa select Assets page");
            string ActualHeadingText = HeadingElement.Text.ToLower();
            (ActualHeadingText).Should().BeEquivalentTo(columnHeadingName, because: columnHeadingName + " column heading should match with the expected value in crogressa select assets page");
        }
        ...
        {
            (_updateSelectDevicesPage.NextButton.Enabled).Should().BeTrue(because: "Next button should be enabled when user selects atleast one device in Progressa Upgrade Select Assets page");
        }
        ...
        public void WhenUserClicksPreviousButton()
        {
            ...
            //For select update page
            if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa select assets previous"))
            {
                _updateSelectDevicesPage.PreviousButton.Click();
            }
            //for select assets page
            else if (_scenarioContext.ScenarioInfo.Title.ToLower().Equals("progressa review action previous"))
            {
        ...
        public void ThenProgressaUpdatesPageIsDisplayed()
        {
            ...
            (IsUpdatePageDisplayed).Should().BeTrue(because: "RV700 update page should be displayed when user cliks previous button in Progressa Upgrade Select Assets page");
        }
        ...
        public void ThenProgressaReviewActionPageIsDisplayed()
        {
            ...
            (IsReviewActionPageDisplayed).Should().BeTrue(because: "Review action page should be displayed when user clicks enabled next button in Progressa Upgrade Select Assets page");
        }

        [Given(@"user is on Progressa Review Action page")]
        public void GivenUserIsOnProgressaReviewActionPage()
        {
            //Navigate select assets page
            GivenUserIsOnProgressaUpgradeSelectAssetsPage();
            ...
            ThenProgressaReviewActionPageIsDisplayed();
        }
        ...
        {
            (_updateSelectDevicesPage.SuccessUpadteMessage.GetElementVisibility()).Should().BeTrue(because: "Update process Message should be displayed when user clicks confirm button In Progressa Upgrade review action page.");
            (_updateSelectDevicesPage.SuccessUpadteMessage.Text).Should().BeEquivalentTo(UpdateSelectDevicesPageExpectedValues.UpdateProcessMessageText, because: "Update message should match with the expected value in Progressa Upgrade review action page");
        }
        ...
        {
            (_updateReviewActionPage.ItemToPushLabel.GetElementVisibility()).Should().BeTrue(because: "Item to push label should be displayed in Progressa Upgrade Review action page.");
            string ActualItemToPushLabelText = _updateReviewActionPage.ItemToPushLabel.Text;
            (ActualItemToPushLabelText).Should().BeEquivalentTo(UpdateReviewActionPageExpectedValues.ItemToPushLabelText, because: "Item to push label text should match with expected value in Progressa Upgrade Review action page");
        }

        [Then(@"Item to push value is displayed")]
        public void ThenItemToPushValueIsDisplayed()
        {
            (_updateReviewActionPage.ItemToPushValue.GetElementVisibility()).Should().BeTrue(because: "Item to push value should be displayed in Progressa Upgrade review action page");
        }

        [Then(@"Destinations label is displayed")]
        public void ThenDestinationsLabelIsDisplayed()
        {
            (_updateReviewActionPage.DestinationLabel.GetElementVisibility()).Should().BeTrue(because: "Destination label should be displayed in Progressa upgrade review action Page.");
            string ActualDesinationLabelText = _updateReviewActionPage.DestinationLabel.Text;
            ActualDesinationLabelText.Should().BeEquivalentTo(UpdateReviewActionPageExpectedValues.DestinationLabelText, because: "Destination label text should match with expected value in Progressa upgrade review action Page.");
        }

        [Then(@"Destinations value is displayed")]
        public void ThenDestinationsValueIsDisplayed()
        {
            (_updateReviewActionPage.DestinationValue.GetElementVisibility()).Should().BeTrue(because: "Destinations value should be displayed in Progressa upgrade review action page");
        }
        ...
        {
            string reviewActionColor = _updateReviewActionPage.Heading.GetCssValue("color");
            (reviewActionColor).Should().BeEquivalentTo(UpdateReviewActionPageExpectedValues.HighlightedHeadingColor, because: "Review action indicator should be highlighted in Progressa review action page");
        }
        ...
        public void ThenConfirmButtonIsEnabled()
        {
            ...
            (IsConfirmButtonEnabled).Should().Be(true, "Confirm button should be enabled in the Progressa review action page.");
        }
