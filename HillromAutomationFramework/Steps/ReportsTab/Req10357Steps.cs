...
namespace HillromAutomationFramework.Steps.ReportsTab
{
    ...
    public sealed class Req10357Steps
    {
        ...
        public Req10357Steps(ScenarioContext scenarioContext, IWebDriver driver)
        {
        ...
        public void ThenFirmwareUpgradeStatusReportProgressaLabelIsDisplayed()
        {
            ...
            (_firmwareStatusPage.FirmwareReportTitle.Text).Should().BeEquivalentTo(FirmwareStatusReportPageExpectedValues.FirmwareUpgradeStatusProgressaLabel, because: "Firmware upgrade status report label should match the expected value in Firmware Status Report page.");
        }
