...
{
    [Binding,Scope(Tag = "SoftwareRequirementID_10364")]
    public class Req10364Steps
    {
        ...
        public Req10364Steps(ScenarioContext scenarioContext, IWebDriver driver)
        {
        ...
        public void GivenUserIsOnPage(string reportType)
        {
            ...
            if (reportType.ToLower().Trim().Equals("progressa activity report"))
            {
        ...
        public void ThenReportIsDownloadedAsCsvFile(string reportName)
        {
            ...
            {
                fileName = ActivityReportPageExpectedValues.ProgressaActivityReportName;
            }
            else
            {
            ...
            (isFileDownloaded).Should().BeTrue(because: reportName + " file should be downloaded when user clicks on download button in progressa activity report page.");
